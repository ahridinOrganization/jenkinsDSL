...
def call(body) {
    ...
    //    def job=stage0(MESSAGE:config.MESSAGE)
        //jobDsl scriptText:
    jobDsl ignoreMissingFiles: true, lookupStrategy: 'SEED_JOB', removedJobAction: 'DISABLE', removedViewAction: 'DELETE', targets: 'stage0.groovy(body)', unstableOnDeprecation: true
   //build job:  job    
